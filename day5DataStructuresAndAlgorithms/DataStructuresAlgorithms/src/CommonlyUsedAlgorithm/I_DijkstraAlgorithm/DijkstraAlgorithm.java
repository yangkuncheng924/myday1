package CommonlyUsedAlgorithm.I_DijkstraAlgorithm;
...
class Graph {
    ...
    private void update(int index) {
        ...
        for (int j = 0; j < matrix[index].length; j++) {
            ...
            //如果j顶点没有被访问过，二千len小于出发顶点到j顶点的距离，就需要更新
